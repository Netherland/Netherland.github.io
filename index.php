...
<body>
  ...
  <div class="bigcontent">
      ...
      <div class="section">
        ...
        <div class="row nomargins">
          ...
          <div class="col s12 m4">
            <div class="icon-block">
              <div class="iconcircle">
                <h2 class="center black-text iconsymbol"><i class="material-icons">web</i></h2></div>
    ...
    <div class="container pictextcontainer moremargins moremarginstopsmall z-depth-1">
      <div class="row center">
        <h2 class="stars"><i class="mdi-action-star-rate yellow-text center starsg"></i><i class="mdi-action-star-rate yellow-text center starsg"></i><i class="mdi-action-star-rate yellow-text center starsg"></i><i class="mdi-action-star-rate yellow-text center starsg"></i><i class="mdi-action-star-rate black-text center"></i></h2>
        <h4>Gemiddeld met 4 sterren beoordeeld</h4>
      </div>
    </div>
      ...
      <div class="section">
        ...
        <div class="row">
          <div class="col s12 center">
            <h3><i class="mdi-action-star-rate brown-text center"></i></h3>
